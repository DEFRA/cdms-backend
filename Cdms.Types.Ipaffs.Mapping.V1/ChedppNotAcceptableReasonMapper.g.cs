...
{
	public static Cdms.Model.Ipaffs.ChedppNotAcceptableReason Map(Cdms.Types.Ipaffs.ChedppNotAcceptableReason from)
	{
	if(from is null)
	{
		return default!;
	}
		var to = new Cdms.Model.Ipaffs.ChedppNotAcceptableReason ();
