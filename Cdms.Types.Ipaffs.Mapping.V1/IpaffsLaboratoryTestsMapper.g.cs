...
{
	public static Cdms.Model.Ipaffs.IpaffsLaboratoryTests Map(Cdms.Types.Ipaffs.IpaffsLaboratoryTests from)
	{
	if(from is null)
	{
		return default!;
	}
		var to = new Cdms.Model.Ipaffs.IpaffsLaboratoryTests ();
