...
{
	public static Cdms.Model.Ipaffs.IpaffsCommodityComplement Map(Cdms.Types.Ipaffs.IpaffsCommodityComplement from)
	{
	if(from is null)
	{
		return default!;
	}
		var to = new Cdms.Model.Ipaffs.IpaffsCommodityComplement ();
