...
public class MongoDbContext(IMongoDatabase database) : IMongoDbContext
{
    ...
    public MongoCollectionSet<ImportNotification> Notifications => new(this, nameof(ImportNotification));

    public MongoCollectionSet<Movement> Movements => new(this, nameof(Movement));

    public MongoCollectionSet<Gmr> Gmrs => new(this, nameof(Gmr));
