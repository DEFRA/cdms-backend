...
namespace CdmsBackend.Cli.Features.GenerateModels.GenerateIpaffsModel.Commands
{
    ...
    class GenerateIpaffsModelCommand : IRequest
    {
        ...
        public class Handler : AsyncRequestHandler<GenerateIpaffsModelCommand>
        {
            ...
            {
                var builder =
                    new IpaffsDescriptorBuilder(new List<ISchemaVisitor>() { new DescriptorBuilderSchemaVisitor() });
